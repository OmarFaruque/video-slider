...
var GOOGLE_FONTS_API = 'https://www.googleapis.com/webfonts/v1/webfonts?key=AIzaSyA98Mf3qguzrtO2pZKNGFyLsHX5qs9s6OA&callback=onFontsLoad'
var GOOGLE_FONTS_API_CSS = 'https://fonts.googleapis.com/css?family='
jQuery('head').append('<script src="'+ GOOGLE_FONTS_API +'">');
...
! function(e) {
    ...
    var y = function(e) {
        var t, n = l.default.Children.count(e.children),
            r = Math.ceil(m(a.default.findDOMNode(e.listRef))),
        ...
        var c = a.default.findDOMNode(e.listRef) && h(a.default.findDOMNode(e.listRef).querySelector('[data-index="0"]')),
            u = c * e.slidesToShow,
    ...
    var w = function(e) {
        ...
        if (r) {
            if (!o && (l < 0 || l >= a)) return {};
            l < 0 ? w = l + a : l >= a && (w = l - a), u && c.indexOf(w) < 0 && c.push(w), S = {
                animating: !0,
                currentSlide: w,
                lazyLoadedList: c
            }, k = {
        ...
        } else v = w, w < 0 ? (v = w + a, o ? a % f !== 0 && (v = a - a % f) : v = 0) : !g(e) && w > d ? w = v = d : p && w >= a ? (w = o ? a : a - 1, v = o ? 0 : a - 1) : w >= a && (v = w - a, o ? a % f !== 0 && (v = 0) : v = a - m), b = L(i({}, e, {
            slideIndex: w
        })), y = L(i({}, e, {
            slideIndex: v
    ...
    t.slideHandler = w;
    var S = function(e, t) {
        var n, r, o, l, a, s = e.slidesToScroll,
            c = e.slidesToShow,
            u = e.slideCount,
            d = e.currentSlide,
            p = e.lazyLoad,
            f = e.infinite;
        if (l = u % s !== 0, n = l ? 0 : (u - d) % s, "previous" === t.message) o = 0 === n ? s : c - n, a = d - o, p && !f && (r = d - o, a = -1 === r ? u - 1 : r);
        else if ("next" === t.message) o = 0 === n ? s : n, a = d + o, p && !f && (a = (d + s) % u + n);
            ...
            if (f) {
                ...
                a > t.currentSlide && "left" === m ? a -= u : a < t.currentSlide && "right" === m && (a += u)
            }
    ...
    var O = function(e, t) {
        ...
        if (!n) {
            ...
            var M = Math.ceil(h / b),
                A = v(t.touchObject, a),
                j = w.swipeLength;
            return y || (0 === c && "right" === A || c + 1 >= M && "left" === A || !g(t) && "left" === A) && (j = w.swipeLength * u, !1 === d && p && (p(A), C.edgeDragged = !0)), (!f && S && (S(A), C.swiped = !0), O = o ? x + j * (k / E) * _ : s ? x - j * _ : x + j * _, a && (O = x + j * _), C = i({}, C, {
                touchObject: w,
                swipeLeft: O,
                trackStyle: P(i({}, t, {
                    left: O
    ...
    var _ = function(e) {
        ...
        if (e.swipeToSlide) {
            var n, r = a.default.findDOMNode(e.listRef),
    ...
    var L = function(e) {
        ...
        var y = 0;
        if (o ? (y = -j(e), s % u !== 0 && r + u > s && (y = -(r > s ? c - (r - s) : s % u)), l && (y += parseInt(c / 2))) : (s % u !== 0 && r + u > s && (y = c - s % u), l && (y = parseInt(c / 2))), g = y * d, b = y * m, t = v ? r * m * -1 + b : r * d * -1 + g, !0 === f) {
            var w, S = a.default.findDOMNode(i);
            if (w = r + j(e), n = S && S.childNodes[w], t = n ? -1 * n.offsetLeft : 0, !0 === l) {
    ...
    t.getPostClones = D;
    var I = function(e) {
        return 1 === e.slideCount ? 1 : j(e) + e.slideCount + D(e)
    };
    t.getTotalSlides = I;
    var z = function(e) {
    ...
    var r = n(6),
        i = (n.n(r), {});
    i.videoslider = wp.element.createElement(
        wp.editor.RichTextToolbarButton, {
            icon: 'editor-code',
            title: 'Sample output',
            onClick: function() {
    ...
    wp.element.createElement(r.SVG, {
        width: "243pt",
        height: "243pt",
        viewBox: "0 0 243 243",
        version: "1.1",
    ...
    (function(e) {
        ...
        var v = r(n(1)),
            ...
            y = r(n(31)),
            w = n(3),
            S = (0, w.canUseDOM)() && n(32),
            k = function(t) {
                function n(e) {
                    var t;
                    return a(this, n), t = u(this, d(n).call(this, e)), h(m(m(t)), "innerSliderRefHandler", function(e) {
                ...
                return p(n, t), c(n, [{
                    ...
                    value: function() {
                        ...
                        for (var a = [], s = null, c = 0; c < i.length; c += t.rows * t.slidesPerRow) {
                            ...
                            t.variableWidth ? a.push(v.default.createElement("div", {
                                key: c,
                                style: {
                                    width: s
                                }
                            }, u)) : a.push(v.default.createElement("div", {
                                key: c
                            }, u))
                        }
                        if ("unslick" === t) {
                        ...
                        return a.length <= t.slidesToShow && (t.unslick = !0), v.default.createElement(g.InnerSlider, o({
    ...
    function l() {
        h && f && (h = !1, f.length ? m = f.concat(m) : v = -1, m.length && a())
    }
    ...
    p.nextTick = function(e) {
        ...
        m.push(new s(e, t)), 1 !== m.length || h || i(a)
            ...
            function t(e) {
                ...
                return c(this, t), n = u(this, d(t).call(this, e)), h(m(m(n)), "listRefHandler", function(e) {
                    ...
                    for (var t = s({
                        ...
                        if ("object" !== a(e[l]) && "function" !== typeof e[l] && e[l] !== n.props[l]) {
                            r = !0;
                            break
                        }
                    }
                    ...
                    if (!0 === n.props.dots && n.state.slideCount >= n.props.slidesToShow) {
                        var a = (0, S.extractObject)(t, ["dotsClass", "slideCount", "slidesToShow", "currentSlide", "slidesToScroll", "clickHandler", "children", "customPaging", "infinite", "appendDots"]),
                        ...
                        }), l = v.default.createElement(E.Dots, a)
                    }
                    ...
                    }, r), n.props.children)), n.props.unslick ? "" : d, n.props.unslick ? "" : l)
    ...
    (function(t) {
        function n(e, t, n) {
            ...
            return t = l(t) || 0, r(n) && (C = !!n.leading, x = "maxWait" in n, g = x ? w(l(n.maxWait) || 0, t) : g, T = "trailing" in n ? !!n.trailing : T), m.cancel = p, m.flush = f, m
        }
    ...
    var v = r(n(1)),
        ...
        k = function(e) {
            var t, n = [],
                ...
                l = (0, b.lazyStartIndex)(e),
                a = (0, b.lazyEndIndex)(e);
            return v.default.Children.forEach(e.children, function(s, c) {
                ...
                if (n.push(v.default.cloneElement(u, {
                    ...
                    var k = o - c;
                    k <= (0, b.getPreClones)(e) && o !== e.slidesToShow && (t = -k, t >= l && (u = s), h = y(m({}, e, {
                        index: t
                    ...
                    }))), o !== e.slidesToShow && (t = o + c, t < a && (u = s), h = y(m({}, e, {
                        index: t
        ...
        E = function(e) {
            function t() {
                return l(this, t), c(this, d(t).apply(this, arguments))
            }
            return p(t, e), s(t, [{
                key: "render",
                value: function() {
    ...
    var h = r(n(1)),
        ...
        b = function(e) {
            function t() {
                return a(this, t), u(this, p(t).apply(this, arguments))
            }
            return f(t, e), c(t, [{
                key: "clickHandler",
                value: function(e, t) {
        ...
        y = function(e) {
            ...
            return m(t, e), u(t, [{
                ...
                value: function() {
                    ...
                    return this.props.prevArrow ? v.default.cloneElement(this.props.prevArrow, l({}, n, r)) : v.default.createElement("button", o({
                        key: "0",
                        type: "button"
                    }, n), " ", "Previous")
                }
    ...
    var w = function(e) {
        ...
        return m(t, e), u(t, [{
            ...
            value: function() {
                ...
                return this.props.nextArrow ? v.default.cloneElement(this.props.nextArrow, l({}, n, r)) : v.default.createElement("button", o({
                    key: "1",
                    type: "button"
                }, n), " ", "Next")
            }
        ...
        function(e) {
            ...
            function a(e) {
                var t = e.clientWidth,
                    n = e.clientHeight;
                if (!t && !n) return E;
                var l = k(e).getComputedStyle(e),
                    a = o(l),
                    c = a.left + a.right,
                    u = a.top + a.bottom,
                    p = r(l.width),
                    f = r(l.height);
                if ("border-box" === l.boxSizing && (Math.round(p + c) !== t && (p -= i(l, "left", "right") + c), Math.round(f + u) !== n && (f -= i(l, "top", "bottom") + u)), !s(e)) {
                    var m = Math.round(p + c) - t,
                        h = Math.round(f + u) - n;
                    1 !== Math.abs(m) && (p -= m), 1 !== Math.abs(h) && (f -= h)
                }
                return d(a.left, a.top, p, f)
            }
    ...
    var r = n(30),
        ...
        o = function(e) {
            ...
            return n.forEach(function(o, l) {
                var a = e[o];
                o = r(o), i(o) && "number" === typeof a && (a += "px"), t += !0 === a ? o : !1 === a ? "not " + o : "(" + o + ": " + a + ")", l < n.length - 1 && (t += " and ")
            }), t
        },
        l = function(e) {
            var t = "";
    ...
    r.prototype = {
        ...
        register: function(e, t, n) {
            ...
            return r[e] || (r[e] = new i(e, o)), a(t) && (t = {
                match: t
            }), s(t) || (t = [t]), l(t, function(t) {
                a(t) && (t = {
                    match: t
                }), r[e].addHandler(t)
            }), this
    ...
    function i(e) {
        var t = e.className,
            ...
            z = function(e) {
                ...
                _ = I(0, t), s("" === t ? void 0 : "" + parseFloat(_) + t)
            },
            R = function(e) {
                var t = e.target.value;
                ...
                D(), s("" === t ? void 0 : "" + parseFloat(t) + M)
            };
        return wp.element.createElement(v, {
            label: i,
            id: C,
            help: f,
            className: a()("eedee-components-unit-button", t)
            ...
            return o(t, e), s(t, [{
                ...
                value: function() {
                    ...
                    return wp.element.createElement("figure", {
                        className: p
                    }, l && wp.element.createElement(d, null, wp.element.createElement("div", {
    ...
    var r = n(6),
        ...
        l = wp.element.createElement(r.SVG, {
            xmlns: "http://www.w3.org/2000/svg",
            width: "20",
            height: "20",
            viewBox: "0 0 24 24"
    ...
    t.a = function(e) {
        ...
        return wp.element.createElement("div", {
            className: g,
            'data-duration': t.singleDuration * 1000
        }, wp.element.createElement("div", null, wp.element.createElement("div", {
            className: "slide-bg"
        }, (m[n] || l.noop)()), wp.element.createElement("div", {
            className: "slide-overlay",
            style: v
        }), wp.element.createElement("div", {
            className: "slide-content"
        }, wp.element.createElement(a.Content, null)), function(e) {
            return wp.element.createElement(s, null)
        }()))
    }
}, , , , , , , , function(e, t, n) {
    "use strict";
    ...
    var r = n(12),
        ...
        m = n(5),
        h = wp.i18n.__,
        v = wp.blocks.registerBlockType;
    v("eedee/block-gutenslider", {
        title: h("Videoslider"),
        description: h("Slider Block for Gutenberg that slides images with arbitrary blocks on top."),
        icon: m.a.videoslider,
        category: "common",
        keywords: [h("Slider"), h("Image"), h("Carousel")],
        attributes: a.d,
        supports: {
            align: ["wide", "full"]
        },
        ...
        save: s.a,
        deprecated: u.a
    }), v("eedee/block-videoslide", {
        title: h("Videoslide"),
        description: h("Single Slide for Videoslider."),
        icon: m.a.videoslider,
        category: "common",
        keywords: [h("Slide"), h("Image"), h("Carousel")],
    ...
    var a = n(19),
        ...
        V = function(e) {
            ...
            function t() {
                ...
                return e.onSelectImage = e.onSelectImage.bind(e), 
                    e.onSelectImages = e.onSelectImages.bind(e), 
                    e.onSelectMedia = e.onSelectMedia.bind(e), 
                    e.onRemoveSlide = e.onRemoveSlide.bind(e), 
                    e.onVerticalAlignChange = e.onVerticalAlignChange.bind(e), 
                    e.getControls.bind(e), 
                    e.setContentMode = e.setContentMode.bind(e), 
                    e.setFadeMode = e.setFadeMode.bind(e), 
                    e.setaudioURL = e.setaudioURL.bind(e), 
                    e.setAudioMode = e.setAudioMode.bind(e), 
                    e.setSlidesToShow = e.setSlidesToShow.bind(e), 
                    e.setSlidesToScroll = e.setSlidesToScroll.bind(e), 
                    e.setPauseOnHover = e.setPauseOnHover.bind(e), 
                    e.setPauseOnFocus = e.setPauseOnFocus.bind(e), 
                    e.setPauseOnDotsHover = e.setPauseOnDotsHover.bind(e), 
                    e.setArrows = e.setArrows.bind(e), 
                    e.setArrowSize = e.setArrowSize.bind(e), 
                    e.setArrowColor = e.setArrowColor.bind(e), 
                    e.setArrowStyle = e.setArrowStyle.bind(e), 
                    e.setDots = e.setDots.bind(e), 
                    e.setDotSize = e.setDotSize.bind(e), 
                    e.setDotColor = e.setDotColor.bind(e), 
                    e.setDotStyle = e.setDotStyle.bind(e), 
                    e.setSliderHeight = e.setSliderHeight.bind(e), 
                    e.setEnableSpacing = e.setEnableSpacing.bind(e), 
                    e.setSpacingX = e.setSpacingX.bind(e), 
                    e.setSpacingY = e.setSpacingY.bind(e), 
                    e.setFullscreen = e.setFullscreen.bind(e), 
                    e.setAutoplay = e.setAutoplay.bind(e), 
                    e.setDuration = e.setDuration.bind(e), 
                    e.setFadeSpeed = e.setFadeSpeed.bind(e), 
                    e.setParallax = e.setParallax.bind(e), 
                    e.setParallaxDirection = e.setParallaxDirection.bind(e), 
                    e.setParallaxAmount = e.setParallaxAmount.bind(e), 
                    e.setOverlayColor = e.setOverlayColor.bind(e), 
                    e.setDimRatio = e.setDimRatio.bind(e), 
                    e.setTextColor = e.setTextColor.bind(e), 
                    e.setMixBlendMode = e.setMixBlendMode.bind(e), 
                    e.setContentOpacity = e.setContentOpacity.bind(e), 
                    e.setEnableMixBlendPreview = e.setEnableMixBlendPreview.bind(e), 
                    e.state = {
                    selectedImage: null,
            ...
            return l(t, e), b(t, [{
                ...
                value: function(e) {
                    ...
                    if (this.setAttributes({
                        ...
                        e.map(function(e) {
                            ...
                            if (t = e.media_type ? "image" === e.media_type ? "image" : "video" : e.type, e.id) {
                                ...
                                if (r) s.push(r);
                                    ...
                                    var i = L("eedee/block-videoslide", {
                                        mediaId: e.id,
                                        mediaUrl: e.url,
                                        mediaAlt: e.alt,
                                        mediaType: t
                        ...
                        var u = [];
                        e.map(function(e) {
                            var t = L("eedee/block-videoslide", {
                                mediaId: e.id,
                                mediaUrl: e.url,
                                mediaAlt: e.alt,
                                mediaType: e.type
            ...
            
            {
                ...
                value: function() {
                    var e = this.props,
                        ...
                        r = t.isEditing,
                        i = t.verticalAlign;
                    return wp.element.createElement(I, null, wp.element.createElement(v.a, {
                        onChange: this.onVerticalAlignChange,
                        value: i
                    }), wp.element.createElement(W, null), wp.element.createElement(W, null, wp.element.createElement(R, {
                        ...
                        className: "components-toolbar__control",
                        label: w(r ? "Preview Slider" : "Edit Slide Content"),
                ...
                value: function() {
                    var e, t, n = this,
                        ...
                        fe = u()(c, (e = {}, r(e, "content-" + y, y), r(e, "has-parallax", !te && re), r(e, "" + C, C), r(e, "" + x, x), r(e, "vertical-align-" + de, de), e)),
                        me = {
                            "--videoslider-min-height": "" + V,
                            "--videoslider-arrow-size": I + "px",
                            "--videoslider-dot-size": D + "px",
                            "--videoslider-arrow-color": "" + B,
                            "--videoslider-dot-color": "" + W,
                            "--videoslider-padding-y-mobile": "" + G + ee,
                            "--videoslider-padding-x-mobile": "" + q + Q,
                        ...
                        }, r(t, "mb-" + ae, i), r(t, "co-" + 100 * se, !0), t)),
                        ve = {
                            backgroundColor: ue
                        },
                        ge = function() {
                            return wp.element.createElement(M, null, wp.element.createElement("div", {
                                className: "slider-overlay",
                                style: ve
                            }), wp.element.createElement(s.a, g({
                                ref: function(e) {
                                    return n.slider = e
                                }
                            }, pe), v.map(function(e) {
                                ...
                                className: he
                            }, ce ? wp.element.createElement(N, null) : f.map(function(e) {
                                return wp.element.createElement(P, {
                                    key: e.clientId
                                }, j(e))
                            })))
                        ...
                        be = function() {
                            return ce ? wp.element.createElement(M, null, wp.element.createElement("div", {
                                className: "videoslider-info"
                            }, wp.element.createElement("span", null, "You are editing Videoslider with ", v.length, " Slides - click "), wp.element.createElement(U, {
                                icon: "visibility",
                                className: "btn-videoslider-info-visibility",
                                onClick: function() {
                                    b(!1)
                                }
                            }), wp.element.createElement("span", null, " to preview the slider and "), wp.element.createElement(R, {
                            ...
                            }), wp.element.createElement("span", null, " to edit slides. Add any blocks you like below.")), wp.element.createElement(N, null)) : wp.element.createElement(s.a, g({
                                ref: function(e) {
                                    return n.slider = e
                                }
                            }, pe), v.map(function(e) {
                    ...
                    return wp.element.createElement(M, null, this.getControls(), Object(p.a)(l, this), d, wp.element.createElement("div", {
                        className: fe,
                        style: me,
                        ...
                        return 0 === v.length ? wp.element.createElement(M, null, wp.element.createElement(H, {
                            icon: wp.element.createElement(z, {
                                icon: m.a.videoslider
                            }),
                            className: c,
                            labels: {
                                title: "Videoslider",
                                instructions: w("Drag images or videos, upload new ones or select files from your library.")
                            },
                            onSelect: n.onSelectMedia,
                            accept: "image/*,video/*",
                            allowedTypes: X,
                            multiple: !0,
                            notices: d
                        })) : ce ? wp.element.createElement(M, null, "fixed" === y && wp.element.createElement("ul", {
                            ...
                            var r = e.attributes,
                                ...
                                l = r.mediaAlt,
                                s = r.mediaType,
                                c = S(w("Slide %1$d of %2$d in Videoslider"), t + 1, v.length);
                            return wp.element.createElement("li", {
                                className: "blocks-gallery-item",
                                key: e.clientId
                            }, wp.element.createElement(h.a, {
                                type: s,
                                url: i,
                                alt: l,
                                id: o,
                                isSelected: a && n.state.selectedImage === t,
                        ...
                        }, "fixed" === y ? ge() : be())) : wp.element.createElement("div", {
                            className: "videoslider-preview"
                        }, "fixed" === y ? ge() : be())
                    }()))
                }
    ...
    t.a = k([C(function(e, t, n) {
        var r = n.select("core/block-editor"),
            i = r.getBlockOrder,
            o = e("core/block-editor"),
            l = o.replaceInnerBlocks,
            a = o.insertBlocks;
        return {
            updateEditable: function(n) {
                var r = t.clientId,
                    o = t.setAttributes,
                    l = e("core/block-editor"),
                    a = l.updateBlockAttributes;
                o({
                    isEditing: n
            ...
            updateSliderBackground: function(n, r) {
                var o = e("core/block-editor"),
                    l = o.updateBlockAttributes,
                    a = t.setAttributes,
                    s = t.clientId,
                    c = {
                        rgbaBackground: Object(f.a)(n, r),
                        overlayColor: n,
                        dimRatio: r
                    };
                a(c), i(s).forEach(function(e) {
                    l(e, g({}, c))
                })
            }
        }
        ...
        var n = t.clientId,
            ...
            i = r.hasSelectedInnerBlock,
            o = r.isBlockSelected,
            l = e("core/editor").getBlocks(n);
        return {
            isStackSelected: o(n) || i(n, !0),
            innerBlocks: l,
            innerSlides: _.filter(l, {
...
const withAdvancedControls = createHigherOrderComponent( ( BlockEdit ) => {
	return ( props ) => {
        ...
        var t = wp.element.createElement(Fragment, null, wp.element.createElement(BlockEdit, props), isSelected && allowedBlocks.includes(name) && wp.element.createElement( InspectorAdvancedControls, null, wp.element.createElement( SelectControl, {
        label: __('Select Font Family'),
        options:allFontNames,
        value: sliderFontFamily,
        onChange: function onChange(sliderFontFamily) {
            jQuery('head').append('<link rel="stylesheet" href="'+ GOOGLE_FONTS_API_CSS +  sliderFontFamily + '">');
            jQuery('p.rich-text.editor-rich-text__editable.block-editor-rich-text__editable.wp-block-paragraph.is-selected').css('font-family', sliderFontFamily);
        
            return setAttributes({
            sliderFontFamily: sliderFontFamily
            });
        },
        help: !!sliderFontFamily ? __('Font family only applicable on Frontend.') : __('Font family only applicable on Frontend.')
        }),
        wp.element.createElement( SelectControl, {
            ...
            value: animationtype,
            onChange: function onChange(animationtype) {
                return setAttributes({
                    animationtype: animationtype
                });
            },
            help: !!animationtype ? __('Animation Effect only applicable on Frontend.') : __('Animation Effect only applicable on Frontend.')
            }
        )));

        // t = wp.element.createElement(h, {
        //     label: l("Font Family"),
        //     value: E,
        //     options: r.b,
        //     onChange: t.setDotStyle
        // });
...
function applyExtraClass( extraProps, blockType, attributes ) {
    ...
    const { sliderFontFamily, animationtype } = attributes;
    
	//check if attribute exists for old Gutenberg version compatibility
	//add class only when sliderFontFamily = false
	//add allowedBlocks restriction
	if ( typeof sliderFontFamily !== 'undefined' && allowedBlocks.includes( blockType.name ) ) {
        extraProps.style['font-family'] = sliderFontFamily;
        extraProps['data-animation'] = animationtype;
	}
	return extraProps;
}
...
addFilter(
    ...
    var r = n(7),
        ...
        blockicon = a.BlockIcon,



        s = a.InspectorControls,
        c = a.PanelColorSettings,
        u = wp.components,
        d = u.Button,
        p = u.PanelBody,
        f = u.RangeControl,
        ...
        h = u.SelectControl;
        var v = u.ButtonGroup,
        g = (u.TabPanel, u.ColorPicker),
        b = u.ColorIndicator,
        mediaupload = u.mediaUpload,
        ...
        w = function(e, t) {
            ...
            var n = e.contentMode,
                ...
                U = e.isFullScreen,
                W = e.fadeSpeed,
                F = (e.hasParallax, e.pauseOnFocus),
                X = e.pauseOnHover,
                Y = e.pauseOnDotsHover,
                V = (e.parallaxDirection, e.parallaxAmount, e.dimRatio),
                q = e.overlayColor,
                G = (e.mixBlendMode, e.autoplay),
                K = (e.contentOpacity, t.state.enableMixBlendPreview, wp.element.createElement("span", {
                    className: "editor-panel-color-settings__panel-title block-editor-panel-color-settings__panel-title"
                }, l("Arrow Settings"), wp.element.createElement(b, {
                ...
                Z = (wp.element.createElement("div", {
                    className: "videoslider-tab-title"
                }, i.a.mobile, wp.element.createElement("span", null, "Mobile")), wp.element.createElement("div", {
                    className: "videoslider-tab-title"
                }, i.a.tablet, wp.element.createElement("span", null, "Tablet")), wp.element.createElement("div", {
                    className: "videoslider-tab-title"
                }, i.a.desktop, wp.element.createElement("span", null, "Desktop")), {
                    mobile: wp.element.createElement(y, null, wp.element.createElement(v, {
                        className: "unit-buttons",
                        "aria-label": l("Spacing Unit")
                    }, ["%", "px"].map(function(e) {
                        var n = B === e;
                    ...
                    tablet: wp.element.createElement(y, null, wp.element.createElement(v, {
                        className: "unit-buttons",
                        "aria-label": l("Spacing Unit")
                    }, ["%", "px"].map(function(e) {
                        var n = B === e;
                    ...
                    desktop: wp.element.createElement(y, null, wp.element.createElement(v, {
                        className: "unit-buttons",
                        "aria-label": l("Spacing Unit")
                    }, ["%", "px"].map(function(e) {
                        var n = B === e;
                    ...
                    all: wp.element.createElement(y, null, wp.element.createElement(v, {
                        className: "unit-buttons",
                        "aria-label": l("Spacing Unit")
                    }, ["%", "px"].map(function(e) {
                        var n = B === e;
            ...
            return wp.element.createElement(s, null, wp.element.createElement( p, {
                title: l("General Slider 3 Settings"),
                className: "videoslider-controls-general"
            }, 

            wp.element.createElement(v, {
                "aria-label": l("Audio Upload"),
                className: "video-slide-audio-upload"
            },
            wp.element.createElement('input', {
                className: 'audio-input hidden',
                key: 'audioURL',
                type:'number',
                value: t.props.attributes.audioURL
            }),
            wp.element.createElement(d, {
                ...
                onClick: function(){
                    wp.media.editor.send.attachment = function(props, attachment) {
                        t.setaudioURL(attachment.id)
                    };
                    wp.media.editor.open();
                }
            }, "Upload Audio " +  t.props.attributes.audioURL)),
                ...
                title: l("Advanced Slider Settings"),
                className: "videoslider-controls-advanced"
            }, !U && wp.element.createElement(o.a, {
                label: l("Slider Height"),
                ...
                label: l("Fullscreen Background Slider"),
                checked: U,
                help: U ? l("Full Screen Background Slider preview is not available in the editor, check the live site to see it in action.") : null,
                onChange: t.setFullscreen
            }), wp.element.createElement(f, {
                label: l("Animation Speed (sec)"),
                value: W,
                onChange: t.setFadeSpeed,
                min: .1,
                max: 10,
                step: .1
            }), !a && wp.element.createElement(f, {
                label: l("Slides to Show"),
                value: _,
                onChange: t.setSlidesToShow,
                min: 1,
                max: 8,
                step: 1
            }), !a && wp.element.createElement(f, {
                label: l("Slides to Scroll"),
                value: M,
                onChange: t.setSlidesToScroll,
                min: 1,
                max: 8,
                step: 1
            })), O && wp.element.createElement(p, {
                title: K,
                ...
                value: T,
                options: r.a,
                onChange: t.setArrowStyle
            }), wp.element.createElement(f, {
                label: l("Arrow Size (px)"),
                value: C,
                ...
                onChangeComplete: function(e) {
                    return t.setArrowColor(e.hex)
                },
                disableAlpha: !0
            })), w && wp.element.createElement(p, {
                title: $,
                ...
                colorSettings: [{
                    value: q,
                    onChange: t.setOverlayColor,
                    label: l("Overlay Color")
                }, {
                    value: x,
                    onChange: t.setArrowColor,
                    label: l("Arrows Color")
                }, {
                    value: k,
                    onChange: t.setDotColor,
                    label: l("Dots Color")
                }]
            }, wp.element.createElement(f, {
                label: l("Overlay Opacity"),
                value: V,
                onChange: t.setDimRatio,
                min: 0,
                max: 1,
                step: .1,
                required: !0
    ...
    var a = n(2),
        ...
        N = function(e) {
            ...
            return {
                ...
                mediaId: t.id,
                mediaLink: t.link,
                mediaUrl: Object(a.get)(e, ["sizes", "large", "url"]) || Object(a.get)(e, ["media_details", "sizes", "large", "source_url"]) || e.url
            }
        },
        H = function(e) {
            function t() {
            ...
            return l(t, e), h(t, [{
                ...
                value: function() {
                    ...
                    return wp.element.createElement(w, null, wp.element.createElement(D, null, wp.element.createElement(p.a, {
                        onChange: this.onVerticalAlignChange,
                        value: h
                        ...
                        className: "slide-bg"
                    }, (v[s] || a.noop)(), x(o) && wp.element.createElement(k, null)), wp.element.createElement("div", {
                        className: "slide-overlay",
                        style: g
                    }), wp.element.createElement("div", {
                        className: "slide-content"
    ...
    t.a = S(v(function(e, t) {
        ...
        return {
            image: i ? d(i) : null,
            hasChildBlocks: l(n).length > 0,
            innerBlocksCount: l(n).length,
            isStackSelected: function e(t) {
                ...
                var n = !0,
                    ...
                    i = void 0;
                try {
                    for (var o, a = l(t)[Symbol.iterator](); !(n = (o = a.next()).done); n = !0) {
                        return e(o.value)
                    }
                } catch (e) {
                    r = !0, i = e
            ...
            innerContent: a(n) ? a(n).innerBlocks : [],
            rootBlock: a(c(n))
        }
    }), M)(H)
}, function(e, t, n) {
    ...
    var r = wp.i18n.__,
        i = wp.editor,
        o = i.InspectorControls,
        l = i.PanelColorSettings,
        a = wp.components,
        s = a.PanelBody,
        c = a.RangeControl,
        u = a.TextControl,
        d = function(e) {
            var t = e.props.attributes,
                n = t.dimRatio,
                i = t.overlayColor,
                a = t.singleDuration;
            return wp.element.createElement(o, null, wp.element.createElement(s, {
                title: r("Slide Setting"),
                className: "videoslider-controls-advanced"
            }, wp.element.createElement(u, {
                label: r("Slide Duration"),
                value: a || "",
                type:'number',
                onChange: e.setSingleDuration,
                help: r("Set an time duration for each slider.")
            })), wp.element.createElement(l, {
                title: r("Colors"),
                initialOpen: !1,
                colorSettings: [{
                    value: i,
                    onChange: e.setOverlayColor,
                    label: r("Overlay Color")
                }]
            }, wp.element.createElement(c, {
                label: r("Overlay Opacity"),
                value: n,
                onChange: e.setDimRatio,
                min: 0,
                max: 1,
                step: .1,
                required: !0
